...
@router.get("/subjects", response_model=list[theory_schemas.SubjectResponse])
async def list_subjects(
    ...
    return await theory_service.list_subjects(skip=pagination.skip, limit=pagination.limit)
...
@router.get("/subjects/{subject_id}/sections", response_model=list[theory_schemas.SectionResponse])
async def list_sections(
    ...
    return await theory_service.list_sections(subject_id, skip=pagination.skip, limit=pagination.limit)


@router.get("/sections/{section_id}/subsections", response_model=list[theory_schemas.SubsectionResponse])
async def list_subsections(
    ...
    return await theory_service.list_subsections(section_id, skip=pagination.skip, limit=pagination.limit)


@router.get(
    "/subsections/{subsection_id}/materials",
    response_model=list[theory_schemas.TheoryMaterialResponse],
)
async def list_materials(
    ...
    return await theory_service.list_materials(
        subsection_id,
        user=current_user,
